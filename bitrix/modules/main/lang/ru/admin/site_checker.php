...
$MESS["SC_HELP_CHECK_REST"] = "Модуль rest должен быть установлен для интеграции с внешними приложенями и работы ряда приложений из marketplace. Вы можете интегрировать свои приложения в Битрикс24 на основе <a href=\"https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=43&LESSON_ID=3568\" target=\"_blank\">документации для разработчиков</a>.";
